...
Suppose we are given a matrix, and want to examine the properties of its null space. Recall that the null space is given by $\left\{ \mathbf{x}: A\mathbf{x} = \mathbf{0}\right\}$%TODO:Check!
